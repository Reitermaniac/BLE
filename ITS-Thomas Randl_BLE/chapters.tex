...
Für den Testaufbau wurden drei \ac{ble} "`Beacons"' der Firma "`Accent Systems"', siehe Abbildung \ref{FIG:beacon}, verwendet.
\begin{figure}[h]
	\centering
...
\begin{figure}[hbtp]
	\centering
	\includegraphics[width=0.25\linewidth]{\figdir/Overview}
