...
\begin{acronym}[ECUAF]
	\acro{att}[ATT]{Attribute Protocoll}
	\acro{ble}[BLE]{Bluetooth Low Energy}
	\acro{eid}[EID]{Ephemeral Identifier}
	...
	\acro{l2cap}[L2CAP]{Logical Link Control and Adaptation Protocol}
	...
	\acro{smt}[SMT]{Security Manager Protocol}
