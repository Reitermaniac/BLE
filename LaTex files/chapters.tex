...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.25\linewidth]{\figdir/Smartwatch}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.60\linewidth]{\figdir/GATT}
...
\begin{figure}[hbtp]
	...
	\begin{subfigure}[t]{0.4\textwidth}
		\includegraphics[width=0.8\textwidth]{\figdir/Overview}
		\subcaption{Hauptmenü des Konfigurationstools "`iBKS Config Tool"' \cite{BKS:WWW}}
		\label{FIG:overview}
	\end{subfigure}
	\begin{subfigure}[t]{0.35\textwidth}
		\includegraphics[width=0.8\textwidth]{\figdir/beacon}
		\subcaption{Beacon der Firma "`Accent Systems"'}
		\label{FIG:beacon}
	\end{subfigure}
...
\begin{figure}[hbtp]
	\centering
	\includegraphics[width=0.25\linewidth]{\figdir/URL}
...
\begin{figure}[hbtp]
	\centering
	\includegraphics[width=0.8\linewidth]{\figdir/Positionsbestimmung}
